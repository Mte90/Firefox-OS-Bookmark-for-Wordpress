...
# main config
PLUGINSLUG="firefox-os-bookmark"
CURRENTDIR=`pwd`
MAINFILE="firefox-os-bookmark.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="Mte90" # your svn username
